...
bool QRegionTypeHelper::acceptInputImpl(AbstractQoreNode *&n, ExceptionSink *xsink) const
{
     ...
     n->deref(xsink);
     // TODO/FIXME: this is valid usage of qt_Smoke - this wile is part of the Qt4 module only
     n = Marshalling::createQoreObjectFromNonQObject(qt_Smoke, QC_QREGION, SCI_QREGION, qr);
     return true;
}
...
bool QBrushTypeHelper::acceptInputImpl(AbstractQoreNode *&n, ExceptionSink *xsink) const
{
     ...
     n->deref(xsink);
     // TODO/FIXME: this is valid usage of qt_Smoke - this wile is part of the Qt4 module only
     n = Marshalling::createQoreObjectFromNonQObject(qt_Smoke, QC_QBRUSH, SCI_QBRUSH, br);
     return true;
}
...
bool QColorTypeHelper::acceptInputImpl(AbstractQoreNode *&n, ExceptionSink *xsink) const
{
     ...
     n->deref(xsink);
     // TODO/FIXME: this is valid usage of qt_Smoke - this wile is part of the Qt4 module only
     n = Marshalling::createQoreObjectFromNonQObject(qt_Smoke, QC_QCOLOR, SCI_QCOLOR, qc);
     return true;
}
...
bool QVariantTypeHelper::acceptInputImpl(AbstractQoreNode *&n, ExceptionSink *xsink) const
{
     ...
     if (n)
          n->deref(xsink);
     // TODO/FIXME: this is valid usage of qt_Smoke - this wile is part of the Qt4 module only
     n = Marshalling::createQoreObjectFromNonQObject(qt_Smoke, QC_QVARIANT, SCI_QVARIANT, q);
     return true;
}
...
bool QKeySequenceTypeHelper::acceptInputImpl(AbstractQoreNode *&n, ExceptionSink *xsink) const
{
     ...
     n->deref(xsink);
     // TODO/FIXME: this is valid usage of qt_Smoke - this wile is part of the Qt4 module only
     n = Marshalling::createQoreObjectFromNonQObject(qt_Smoke, QC_QKEYSEQUENCE, SCI_QKEYSEQUENCE, qks);
     return true;
}
...
bool QDateTypeHelper::acceptInputImpl(AbstractQoreNode *&n, ExceptionSink *xsink) const
{
     ...
     n->deref(xsink);
     // TODO/FIXME: this is valid usage of qt_Smoke - this wile is part of the Qt4 module only
     n = Marshalling::createQoreObjectFromNonQObject(qt_Smoke, QC_QDATE, SCI_QDATE, date);
     return true;
}
...
bool QDateTimeTypeHelper::acceptInputImpl(AbstractQoreNode *&n, ExceptionSink *xsink) const
{
     ...
     n->deref(xsink);
     // TODO/FIXME: this is valid usage of qt_Smoke - this wile is part of the Qt4 module only
     n = Marshalling::createQoreObjectFromNonQObject(qt_Smoke, QC_QDATETIME, SCI_QDATETIME, date);
     return true;
}
...
bool QTimeTypeHelper::acceptInputImpl(AbstractQoreNode *&n, ExceptionSink *xsink) const
{
     ...
     n->deref(xsink);
     // TODO/FIXME: this is valid usage of qt_Smoke - this wile is part of the Qt4 module only
     n = Marshalling::createQoreObjectFromNonQObject(qt_Smoke, QC_QTIME, SCI_QTIME, time);
     return true;
}
